...
IMAGE_THUMBNAIL = (145, 115)
ALLOWED_IMAGE_QUANT = 20
IMAGES_IN_SCROLL = 3
...
DATABASES = {
    'default': {
        ...
        'NAME': 'booksonline',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '7ocq@&rac1i5#p!j%@gqu=*!pn*okcuy92n8ck0-&d#g=h16&h'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': "/home/andriy/workspace/books-online/logfile",
            'maxBytes': 50000,
            'backupCount': 2,
            'formatter': 'simple',
        },
