...
urlpatterns = patterns('catalogue.views',
    ...
    url(r'^catalogue/insert-book-attribute/$', 'cover.insertBookAttribute'),
    ...
    url(r'^ajax-catalogue/bookattribute/remove/$',              'cover.remove'),
    url(r'^ajax-catalogue/bookcategory/edit-load-data/$',       'category.edit_load_data'),
    url(r'^ajax-catalogue/bookattribute/edit-load-data/$',      'cover.loadEditData'),
    url(r'^ajax-catalogue/bookcategory/valid-name/$',           'category.valid_name'),
    url(r'^ajax-catalogue/bookattribute/valid-name/$',          'cover.validName'),
